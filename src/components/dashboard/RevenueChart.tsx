...
function ChartTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="rounded-[4px] border border-graphite bg-ink px-3 py-2 shadow-lg">
      ...
      <ResponsiveContainer width="100%" height="100%" debounce={50}>
        <AreaChart data={data} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
          ...
          <XAxis
            ...
            tickLine={false}
            axisLine={false}
            tick={{ fill: "#878c99", fontSize: 11, fontFamily: "var(--font-geist-mono)" }}
            dy={6}
          />
          <YAxis
            tickLine={false}
          ...
          <Area
            ...
            activeDot={{ r: 4, fill: "#a8ff53", stroke: "#121317", strokeWidth: 2 }}
