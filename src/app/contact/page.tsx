  ...
  return (
    ...
    >
      ...
      <Reveal className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="flex h-full flex-col rounded-[4px] border border-signal/35 bg-ink p-6">
          <span className="grid h-10 w-10 place-items-center rounded-[4px] border border-signal/30 bg-signal/10 text-signal">
            <Rocket className="h-5 w-5" />
          </span>
          <h2 className="mt-5 font-display text-lg font-medium tracking-[0.025em] text-bone">
        ...
        {/* Direct email */}
        <div className="flex h-full flex-col rounded-[4px] border border-hairline bg-ink p-6">
          <span className="grid h-10 w-10 place-items-center rounded-[4px] border border-hairline bg-canvas text-cloud">
      ...
      {whatsappContacts.length > 0 ? (
        <Reveal className="rounded-[4px] border border-hairline bg-ink p-6">
          <div className="flex items-start gap-4">
            <span className="grid h-10 w-10 shrink-0 place-items-center rounded-[4px] border border-signal/30 bg-signal/10 text-signal">
              <MessageCircle className="h-5 w-5" />
            </span>
            <div>
              <h2 className="font-display text-lg font-medium tracking-[0.025em] text-bone">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            {whatsappContacts.map((c) => (
              <a
                ...
                className="group flex items-center justify-between gap-3 rounded-[4px] border border-hairline bg-canvas px-4 py-3 transition hover:border-graphite"
              >
      ...
      {/* Region note */}
      <Reveal className="rounded-[4px] border border-hairline bg-canvas/60 p-6">
