    ...
    <AnimatePresence>
      {visible ? (
        <motion.div
          ...
          className="fixed inset-x-3 bottom-3 z-50 mx-auto max-w-2xl rounded-[10px] border border-hairline bg-ink/95 p-4 shadow-[0_18px_40px_-20px_rgba(0,0,0,0.8)] backdrop-blur-[6px] sm:inset-x-auto sm:right-4 sm:left-auto sm:bottom-4"
        >
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <button
                type="button"
                onClick={dismiss}
                className="mt-3 inline-flex items-center rounded-[10px] border border-hairline bg-canvas px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.08em] text-cloud transition hover:border-graphite hover:text-bone focus-ring"
              >
                Got it
              </button>
            </div>
            <button
              ...
              onClick={dismiss}
              className="grid h-7 w-7 shrink-0 place-items-center rounded-[10px] text-fog transition hover:bg-canvas hover:text-bone focus-ring"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
