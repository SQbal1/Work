...
export function InvoiceBuilder({ invoiceId }: { invoiceId?: string }) {
  ...
  return (
    <div>
      ...
      <div className="mb-4 flex rounded-[10px] border border-hairline bg-ink p-1 lg:hidden">
        {(["edit", "preview"] as const).map((v) => (
          <button
            ...
            className={cn(
              "flex flex-1 items-center justify-center gap-1.5 rounded-[10px] px-3 py-1.5 text-sm font-medium transition",
      ...
      <div className={cn("mt-8", mobileView === "edit" && "hidden lg:block")}>
        ...
        <div className="rounded-[10px] border border-hairline bg-ink p-3 sm:p-6">
...
function LineItemRow({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 gap-2 rounded-[10px] border bg-ink p-3 transition-colors duration-500 sm:grid-cols-12 sm:items-center sm:p-2",
