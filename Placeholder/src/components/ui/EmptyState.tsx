...
export function EmptyState({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col items-center justify-center overflow-hidden rounded-[10px] border border-dashed border-hairline bg-ink/55 px-6 py-14 text-center",
        className,
      )}
    >
      ...
      <h3 className="relative mt-4 font-display font-semibold tracking-tight text-bone">{title}</h3>
