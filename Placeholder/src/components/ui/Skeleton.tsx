...
export function Skeleton({ className }: { className?: string }) {
  return (
    <div className={cn("relative overflow-hidden rounded-[10px] bg-white/[0.04]", className)}>
...
function CardSkeleton({ className, children }: { className?: string; children?: ReactNode }) {
  return <div className={cn("rounded-[10px] border border-hairline bg-canvas", className)}>{children}</div>;
}
