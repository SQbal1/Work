...
export function createSeedDatabase(): Database {
  ...
  return {
    ...
    settings: {
      ...
      invoiceLetterheadTopMm: 45,
      invoiceLetterheadBottomMm: 25,
      invoiceFooterText: "This is a computer-generated tax invoice.",
      invoiceLogoDataUrl: "",
      invoiceStampDataUrl: "",
      invoiceStampEnabled: false,
      invoiceTermsText:
        "Payment due within 30 days of the issue date. A 1.5% monthly late fee applies to overdue balances. Goods and services remain the property of the seller until paid in full.",
      invoiceBankDetails:
        "Riyadh Advisory Company LLC\nAlinma Bank · IBAN SA44 2000 0001 2345 6789 1234\nSWIFT/BIC: INMASARI",
    },
    customers,
    products,
    invoices,
